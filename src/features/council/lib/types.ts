...
// Re-exporting canonical types for backward compatibility or niche use
export type { ModeBehavior, SynthesisConfig, SynthesisTier } from '@/lib/types';
import type { ModeBehavior } from '@/lib/types';
